...
export class GoalComponent implements OnInit {
    goals: Goal[] = [
      new Goal(1, 'Watch finding Nemo', 'Find an online version and watch merlin find his son',new Date(2025,3,14)),
    new Goal(2,'Buy Cookies','I have to buy cookies for the parrot',new Date(2022,6,9)),
    new Goal(3,'Get new Phone Case','Diana has her birthday coming up soon',new Date(2023,1,12)),
    new Goal(4,'Get Dog Food','Pupper likes expensive snacks',new Date(2027,0,18)),
    new Goal(5,'Solve math homework','Damn Math',new Date(2029,2,14)),
